...
logger = CSVLogger("logs", name="KD_EMBEDDING_CD_ONLY_CVUSA")
...
trainer.fit(model, train_loader, val_loader)#, ckpt_path = "logs/KD_EMBEDDING_CD_ONLY_CVUSA/version_0/checkpoints/tinyvit.ckpt")
